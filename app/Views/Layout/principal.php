...
<html>
  <head> 
    ...
    <title>INFOPLUS-OS | <?php echo $this->renderSection('titulo'); ?> </title>
  ...
  <body>
          ...
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
              <!-- Please do not remove the backlink to us unless you support us at https://bootstrapious.com/donate. It is part of the license conditions. Thank you for understanding :)-->
               <p class="no-margin-bottom"><?php echo date('Y'); ?> &copy; Infoplus Tecnologia <a target="_blank" href="https://templateshub.net"> Sistemas Inteligentes</a>.</p>
            </div>
          </div>
        </footer>
      </div>
    ...
    <script src="<?php echo site_url('recursos/'); ?>/popper.js/umd/popper.min.js"> </script>
